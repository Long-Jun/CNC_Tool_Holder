 ...
 * */
s32 RAK12029_LDC1614_Inductive::LDC1614_single_channel_config(u8 channel, float rp, float inductance, float capatance, float q)
{
...
/**@brief Configure four channels and set inductance、capatance
   ...
   @return If the configuration is successful, return 0, otherwise return something else
 * */
s32 RAK12029_LDC1614_Inductive::LDC1614_mutiple_channel_config(float rp, float inductance, float capatance, float q)
{
  /*Set coil inductor parameter first.*/
  ...
  // LDC1614_set_mux_config(0x20c);    //SI NGLE channel config
  /*start channel 0*/
