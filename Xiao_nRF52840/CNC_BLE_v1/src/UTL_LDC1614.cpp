...
#include "UTL_LDC1614.h"
#include "math.h"

/**@brief read sensor's information
 * */
void UTL_LDC1614_Inductive::LDC1614_read_sensor_infomation()
{
  u16 value = 0;
 ...
 * */
UTL_LDC1614_Inductive::UTL_LDC1614_Inductive(u8 IIC_ADDR)
{
...
/**@brief config sensor
   @return 0:succeeded
 * */
s32 UTL_LDC1614_Inductive::LDC1614_init()
{
 ...
 * */
s32 UTL_LDC1614_Inductive::LDC1614_single_channel_config(u8 channel, float rp, float inductance, float capatance, float q)
{
  ...
  LDC1614_set_conversion_time(channel, 0xFFFF);

  /*Set driver current!*/
  LDC1614_set_driver_current(channel, 0x7000);

  /*single conversion*/
  LDC1614_set_mux_config(0x20D);
  /*start channel 0*/
  u16 config = 0x1601;  // external OSC
  // 16 config = 0x1401;  // internal OSC
...
/**@brief Configure four channels and set inductance、capatance
   ...
   @return If the configuration is successful, return 0, otherwise return something else
 * */
s32 UTL_LDC1614_Inductive::LDC1614_mutiple_channel_config(float rp, float inductance, float capatance, float q)
{
  /*Set coil inductor parameter first.*/
  ...
  //Channel 0
  LDC1614_set_Rp(LDC1614_CHANNEL_0, rp);
  LDC1614_set_L(LDC1614_CHANNEL_0, inductance);
  LDC1614_set_C(LDC1614_CHANNEL_0, capatance);  
  LDC1614_set_Q_factor(LDC1614_CHANNEL_0, q);

  //Channel 1
  LDC1614_set_Rp(LDC1614_CHANNEL_1, rp);
  LDC1614_set_L(LDC1614_CHANNEL_1, inductance);
  LDC1614_set_C(LDC1614_CHANNEL_1, capatance);  
  LDC1614_set_Q_factor(LDC1614_CHANNEL_1, q);

  //Channel 2
  LDC1614_set_Rp(LDC1614_CHANNEL_2, rp);
  LDC1614_set_L(LDC1614_CHANNEL_2, inductance);
  LDC1614_set_C(LDC1614_CHANNEL_2, capatance);  
  LDC1614_set_Q_factor(LDC1614_CHANNEL_2, q);

  //Channel 3
  LDC1614_set_Rp(LDC1614_CHANNEL_3, rp);
  LDC1614_set_L(LDC1614_CHANNEL_3, inductance);
  LDC1614_set_C(LDC1614_CHANNEL_3, capatance);  
  LDC1614_set_Q_factor(LDC1614_CHANNEL_3, q);
  ...
  /*Set conversion interval time*/
  LDC1614_set_conversion_time(LDC1614_CHANNEL_0, 0xFFFF);
  LDC1614_set_conversion_time(LDC1614_CHANNEL_1, 0xFFFF); 
  /*********LDC1614**************/
  LDC1614_set_conversion_time(LDC1614_CHANNEL_2, 0xFFFF);
  LDC1614_set_conversion_time(LDC1614_CHANNEL_3, 0xFFFF);

  /*Set driver current!*/
  LDC1614_set_driver_current(LDC1614_CHANNEL_0, 0x7000);
  LDC1614_set_driver_current(LDC1614_CHANNEL_1, 0x7000);
  /*********LDC1614**************/
  LDC1614_set_driver_current(LDC1614_CHANNEL_2, 0x7000);
  LDC1614_set_driver_current(LDC1614_CHANNEL_3, 0x7000);

  /*mutiple conversion*/
  // 0x1B
  //LDC1614_set_mux_config(0xC20D); // LDC 1614 four channel config
  LDC1614_set_mux_config(0x820D);   //LDC 1612 two channel config
  //LDC1614_set_mux_config(0x20D);    //SINGLE channel config
  /*start channel 0*/
  //LDC1614_set_sensor_config(0x1401);


  // 0x1A
  LDC1614_set_sensor_config(0x1601);      // external OSC
  // LDC1614_set_sensor_config(0x1401);   // internal OSC
  // u16 config = 0x1401;
...
/**@brief parse the data which read from data register.
   ...
   @return If the configuration is successful, return 0, otherwise return something else
 * */
s32 UTL_LDC1614_Inductive::LDC1614_parse_result_data(u8 channel, u32 raw_result, u32 *result)
{
  u8 value = 0;
...
/**@brief read the raw channel result from register.
   ...
   @return If the configuration is successful, return 0, otherwise return something else
 * */
s32 UTL_LDC1614_Inductive::LDC1614_get_channel_result(u8 channel, u32 *result)
{
  u32 raw_value = 0;
  if (NULL == result)
  {
 ...
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_conversion_time(u8 channel, u16 value)
{
...
/**@brief set conversion offset.
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_conversion_offset(u8 channel, u16 value)
{
...
/**@brief Before conversion,wait LC sensor stabilize for a short time.
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_LC_stabilize_time(u8 channel)
{
  u16 value = 0;
  value = 0x0032;
  return IIC_write_16bit(LDC1614_SET_LC_STABILIZE_REG_START + channel, value);
...
/**@brief set input frequency divide and LDC1614_Fref divide.
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_FIN_LDC1614_Fref_DIV(u8 channel)
{
  u16 value;
...
/**@brief Error output config.
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_ERROR_CONFIG(u16 value)
{
...
/**@brief Channel Multiplexing Configuration
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_mux_config(u16 value)
{
...
/**@brief reset sensor.
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_reset_sensor()
{
...
/**@brief set drive current of sensor.
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_driver_current(u8 channel, u16 value)
{
...
/**@brief Main config part of sensor.Contains select channel、start conversion、sleep mode、sensor activation mode、INT pin disable ..
   ...
   @return If the configuration is successful, return 1, otherwise return 0
 * */
s32 UTL_LDC1614_Inductive::LDC1614_set_sensor_config(u16 value)
{
 ...
 * */
void UTL_LDC1614_Inductive::LDC1614_select_channel_to_convert(u8 channel, u16 *value)
{
  switch (channel)
  {
    case 0:
 ...
 * */
void UTL_LDC1614_Inductive::LDC1614_set_Rp(u8 channel, float n_kom)
{
 ...
 * */
void UTL_LDC1614_Inductive::LDC1614_set_L(u8 channel, float n_uh)
{
 ...
 * */
void UTL_LDC1614_Inductive::LDC1614_set_C(u8 channel, float n_pf)
{
  LDC1614_capacitance[channel] = n_pf;
}

void UTL_LDC1614_Inductive::LDC1614_set_Q_factor(u8 channel, float q)
{
 ...
 * */
s32 UTL_LDC1614_Inductive::LDC1614_sensor_status_parse(u16 value)
{
  u16 section = 0;
  section = value >> 14;
  switch (section)
 ...
 * */
u32 UTL_LDC1614_Inductive::LDC1614_get_sensor_status()
{
  u16 value = 0;
...
s32 UTL_LDC1614_Inductive::IIC_write_byte(u8 reg, u8 byte)
{
...
s32 UTL_LDC1614_Inductive::IIC_write_16bit(u8 reg, u16 value)
{
  Wire.beginTransmission(_IIC_ADDR);
  Wire.write(reg);
...
void UTL_LDC1614_Inductive::IIC_read_byte(u8 reg, u8 *byte)
{
  Wire.beginTransmission(_IIC_ADDR);
  Wire.write(reg);
...
void UTL_LDC1614_Inductive::IIC_read_16bit(u8 start_reg, u16 *value)
{
  u8 val = 0;
  *value = 0;
  Wire.beginTransmission(_IIC_ADDR);
...
void UTL_LDC1614_Inductive::set_iic_addr(u8 IIC_ADDR)
{
  _IIC_ADDR = IIC_ADDR;
}
