...
#ifndef _UTL_LDC1614_H
#define _UTL_LDC1614_H

#include <Wire.h>
#include <Arduino.h>

#ifndef UTL_LDC1614_DEFINES
#define UTL_LDC1614_DEFINES
...
/****************************************************
   UTL_LDC1614_Inductive  Class
 ***************************************************/
class UTL_LDC1614_Inductive
{
  public:
    UTL_LDC1614_Inductive(u8 IIC_ADDR = DEFAULT_IIC_ADDRESS);
    ~UTL_LDC1614_Inductive() {}
    void IIC_begin()
    {
      Wire.begin();
    }
    ...
    s32 LDC1614_single_channel_config(u8 channel, float rp, float inductance, float capatance, float q);
    s32 LDC1614_mutiple_channel_config(float rp, float inductance, float capatance, float q);
